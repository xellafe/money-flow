...
```
bg-blue-500 hover:bg-blue-600 text-white rounded-lg px-3 py-1.5
...
<p className="text-sm text-gray-500 mb-3">
  Versione corrente: <span className="font-medium text-gray-700">{updateStatus.appVersion}</span>
</p>
```
...
<button className="bg-blue-500 hover:bg-blue-600 text-white rounded-lg px-4 py-2 text-sm font-medium transition-colors cursor-pointer">
  Installa e riavvia
</button>
```
...
*Phase: 10-update-ui | UI-SPEC status: draft | Created: 2026-04-03*
